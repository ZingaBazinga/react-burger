...
export function BurgerConstructorIngredients({ ingredient, constructorItems }: BurgerConstructorIngredientsProps) {
    ...
    const [{ isHover }, drop] = useDrop({
        ...
        drop: (
            ...
            dispatch(moveBurgerConstructor({ dragIndex: item.index, hoverIndex: ingredient.index }));
    ...
    return (
        <div
            ...
            className={`${styles.burger_constructor_item} ${isHover ? styles.hover : ""} ${isDragging ? styles.dragging : ""}`}
        >
            ...
            <ConstructorElement
                ...
                handleClose={() => {
                    const oldItem = constructorItems.find((item) => item._id === ingredient.ingredient._id);
                    dispatch(deleteBurgerConstructor({ ...ingredient, index: ingredient.index }));
